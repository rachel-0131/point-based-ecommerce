...
export class InsufficientPointsException extends BadRequestException {
	constructor(message: string = ERROR_MESSAGES.INSUFFICIENT_POINTS) {
		super(message);
	}
}

export class InsufficientStockException extends BadRequestException {
	constructor(message: string = ERROR_MESSAGES.INSUFFICIENT_STOCK) {
		super(message);
	}
}
...
export class ProductNotAvailableException extends BadRequestException {
	constructor(message: string = ERROR_MESSAGES.PRODUCT_NOT_AVAILABLE) {
		super(message);
	}
}
