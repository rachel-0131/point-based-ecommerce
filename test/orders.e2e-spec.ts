...
describe('OrdersController (e2e)', () => {
  ...
  describe('/orders (POST)', () => {
    it('should create a new order successfully', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect((res) => {
          ...
          expect(mock_ordersService.create).toHaveBeenCalledWith(create_order_dto);
        });
    });
    ...
    it('should fail when quantity is missing (not optional in validation)', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(400)
        .expect((res) => {
          expect(res.body.message).toContain('주문 수량은 정수여야 합니다');
        });
    });
    ...
    it('should fail when user_id is less than 1', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(400)
        .expect((res) => {
          expect(res.body.message).toContain('사용자 ID는 1 이상이어야 합니다');
        });
    });
    ...
    it('should fail when user_id exceeds maximum', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(400)
        .expect((res) => {
          expect(res.body.message).toContain('사용자 ID가 유효 범위를 초과했습니다');
        });
    });
    ...
    it('should fail when user_id is not an integer', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(400)
        .expect((res) => {
          expect(res.body.message).toContain('사용자 ID는 정수여야 합니다');
        });
    });
    ...
    it('should fail when product_id is less than 1', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(400)
        .expect((res) => {
          expect(res.body.message).toContain('상품 ID는 1 이상이어야 합니다');
        });
    });
    ...
    it('should fail when product_id exceeds maximum', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(400)
        .expect((res) => {
          expect(res.body.message).toContain('상품 ID가 유효 범위를 초과했습니다');
        });
    });
    ...
    it('should fail when product_id is not an integer', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(400)
        .expect((res) => {
          expect(res.body.message).toContain('상품 ID는 정수여야 합니다');
        });
    });
    ...
    it('should fail when quantity is less than 1', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(400)
        .expect((res) => {
          expect(res.body.message).toContain('주문 수량은 1 이상이어야 합니다');
        });
    });
    ...
    it('should fail when quantity exceeds maximum', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(400)
        .expect((res) => {
          expect(res.body.message).toContain('한 번에 주문할 수 있는 최대 수량은 100개입니다');
        });
    });
  ...
  describe('/orders (GET)', () => {
    it('should return orders for a specific user', () => {
      const mock_orders = [
        { orderId: 1, product: '상품A', quantity: 2 },
        { orderId: 2, product: '상품B', quantity: 1 },
      ];
      ...
      return request(app.getHttpServer())
        ...
        .expect((res) => {
          ...
          expect(mock_ordersService.findByUserId).toHaveBeenCalledWith(1);
        });
    });
    ...
    it('should fail when user_id query parameter is missing', () => {
      return request(app.getHttpServer())
        ...
        .expect((res) => {
          ...
          expect(mock_ordersService.findByUserId).not.toHaveBeenCalled();
        });
    });
    ...
    it('should handle negative user_id (ParseIntPipe allows it)', () => {
      const mock_orders = [{ orderId: 1, product: '상품A', quantity: 1 }];
    ...
    it('should handle zero user_id (ParseIntPipe allows it)', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect((res) => {
          expect(res.body).toEqual(mock_orders);
          expect(mock_ordersService.findByUserId).toHaveBeenCalledWith(0);
        });
    });
    ...
    it('should handle large valid user_id', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect((res) => {
          expect(res.body).toEqual(mock_orders);
          expect(mock_ordersService.findByUserId).toHaveBeenCalledWith(large_user_id);
        });
    });
  });
});